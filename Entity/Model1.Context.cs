...
namespace Poliklinika.Entity
{
    ...
    {
        private static PoliklinikaEntities _context;
        public static PoliklinikaEntities GetContext()
        {
            if (_context == null)
                _context = new PoliklinikaEntities();
            return _context;
        }
        ...
        public virtual DbSet<HistoryOfDisease> HistoryOfDisease { get; set; }
